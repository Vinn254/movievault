...
export const moviesAPI = {
  ...
  likeMovie: (movieId, reaction) => api.post('/api/like', { movie_id: movieId, reaction }),
  getComments: (movieId) => api.get(`/api/movies/${movieId}/comments`),
  addComment: (movieId, text) => api.post(`/api/movies/${movieId}/comments`, { movie_id: movieId, text }),
